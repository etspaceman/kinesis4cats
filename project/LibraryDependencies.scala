...
object LibraryDependencies {
  ...
  object Aws {
    ...
    object V2 {
      val awssdkVersion =
        "2.46.21" // Should be the same as the latest version in the KCL or KPL
  ...
  object Http4s {
    ...
    val blazeClient =
      Def.setting("org.http4s" %%% "http4s-blaze-client" % "0.23.18")
  ...
  object Smithy {
    ...
    val cloudwatch = "software.amazon.api.models" % "cloudwatch" % "1.0.16"
  }
